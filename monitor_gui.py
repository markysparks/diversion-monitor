...
class MainView:
    """Main GUI class responsible for initiating separate window frames
    for the various display elements."""
...
class AppView:
    """Label window frame containing the widgets for displaying Obs time,
    latest and previous QNH. """

    def __init__(self, root):
        self.frame_metar_monitor = tk.LabelFrame(root, text='ICAO Selector')
        self.frame_metar_monitor.grid(row=0, column=0, columnspan=2,
...
class ControlsView:
    ...
    def __init__(self, root):
        ...
        self.monitor_button = ttk.Button(self.frame_controls,
                                         text='Start Monitor', width=12)
        self.monitor_button.grid(sticky=tk.W, row=0, column=0, padx=5, pady=5)

        self.time_label = ttk.Label(self.frame_controls,
                                    text="Last Check:", anchor=tk.E)
        self.time_label.grid(row=0, column=2, columnspan=1, padx=5, pady=5)

        self.time = tk.StringVar()
        self.time_result = ttk.Label(self.frame_controls,
                                     textvariable=self.time,
                                     width=8, anchor=tk.W)
        self.time_result.grid(row=0, column=3, columnspan=1, padx=5, pady=5)

        self.update_data_button = ttk.Button(self.frame_controls,
                                             text='Update Now', width=12)
        self.update_data_button.grid(sticky=tk.E, row=0, column=8,
                                     padx=5, pady=5)

        self.exit_button = ttk.Button(self.frame_controls, text='Save & Exit')
