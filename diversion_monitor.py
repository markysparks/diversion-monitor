...
class Controller:
    ...
    def __init__(self):
        ...
        """Dictionaries for holding ICAO station message and colour state parameters etc."""
        ...
        self.main_view.app_view.viewICAO0_button.bind('<Button>', self.view_metar_taf_icao0_data)
        self.main_view.app_view.viewICAO0_button.bind('<Return>', self.view_metar_taf_icao0_data)
        self.main_view.app_view.viewICAO1_button.bind('<Button>', self.view_metar_taf_icao1_data)
        self.main_view.app_view.viewICAO1_button.bind('<Return>', self.view_metar_taf_icao1_data)
        self.main_view.app_view.viewICAO2_button.bind('<Button>', self.view_metar_taf_icao2_data)
        self.main_view.app_view.viewICAO2_button.bind('<Return>', self.view_metar_taf_icao2_data)
        self.main_view.app_view.viewICAO3_button.bind('<Button>', self.view_metar_taf_icao3_data)
        self.main_view.app_view.viewICAO3_button.bind('<Return>', self.view_metar_taf_icao3_data)
        self.main_view.app_view.viewICAO4_button.bind('<Button>', self.view_metar_taf_icao4_data)
        self.main_view.app_view.viewICAO4_button.bind('<Return>', self.view_metar_taf_icao4_data)
        self.main_view.app_view.viewICAO5_button.bind('<Button>', self.view_metar_taf_icao5_data)
        self.main_view.app_view.viewICAO5_button.bind('<Return>', self.view_metar_taf_icao5_data)
        self.main_view.app_view.viewICAO6_button.bind('<Button>', self.view_metar_taf_icao6_data)
        self.main_view.app_view.viewICAO6_button.bind('<Return>', self.view_metar_taf_icao6_data)
        self.main_view.app_view.viewICAO7_button.bind('<Button>', self.view_metar_taf_icao7_data)
        self.main_view.app_view.viewICAO7_button.bind('<Return>', self.view_metar_taf_icao7_data)
        self.main_view.app_view.viewICAO8_button.bind('<Button>', self.view_metar_taf_icao8_data)
        self.main_view.app_view.viewICAO8_button.bind('<Return>', self.view_metar_taf_icao8_data)
        self.main_view.app_view.viewICAO9_button.bind('<Button>', self.view_metar_taf_icao9_data)
        self.main_view.app_view.viewICAO9_button.bind('<Return>', self.view_metar_taf_icao9_data)
    ...
    def start_monitor(self, event):
        """Start the automatic monitoring of entered ICAOs, initial messages are collected and fields updated
        before setting scheduled checking
    ...
    def update_display(self):
        """For each ICAO field, get the ICAO, check for the latest messages (METAR/SPECI/TAF) and update the
        station dictionary with the new data. Then update the window fields. Note 'check_metars_tafs() should always
        be called before updating the display to ensure that the latest data has been retried from the WFS server"""
        ...
        self.icao0_data.update_icao_data(icao0, icao0_metar_data[0], icao0_metar_data[1], icao0_taf_data[0],
                                         icao0_taf_data[1], self.icao0_data.station_dict)
        self.update_fields.update_icao0(self.icao0_data.station_dict, self.main_view)
        ...
        self.icao1_data.update_icao_data(icao1, icao1_metar_data[0], icao1_metar_data[1], icao1_taf_data[0],
                                         icao1_taf_data[1], self.icao1_data.station_dict)
        self.update_fields.update_icao1(self.icao1_data.station_dict, self.main_view)
        ...
        self.icao2_data.update_icao_data(icao2, icao2_metar_data[0], icao2_metar_data[1], icao2_taf_data[0],
                                         icao2_taf_data[1], self.icao2_data.station_dict)
        self.update_fields.update_icao2(self.icao2_data.station_dict, self.main_view)
        ...
        self.icao3_data.update_icao_data(icao3, icao3_metar_data[0], icao3_metar_data[1], icao3_taf_data[0],
                                         icao3_taf_data[1], self.icao3_data.station_dict)
        self.update_fields.update_icao3(self.icao3_data.station_dict, self.main_view)
        ...
        self.icao4_data.update_icao_data(icao4, icao4_metar_data[0], icao4_metar_data[1], icao4_taf_data[0],
                                         icao4_taf_data[1], self.icao4_data.station_dict)
        self.update_fields.update_icao4(self.icao4_data.station_dict, self.main_view)
        ...
        self.icao5_data.update_icao_data(icao5, icao5_metar_data[0], icao5_metar_data[1], icao5_taf_data[0],
                                         icao5_taf_data[1], self.icao5_data.station_dict)
        self.update_fields.update_icao5(self.icao5_data.station_dict, self.main_view)
        ...
        self.icao6_data.update_icao_data(icao6, icao6_metar_data[0], icao6_metar_data[1], icao6_taf_data[0],
                                         icao6_taf_data[1], self.icao6_data.station_dict)
        self.update_fields.update_icao6(self.icao6_data.station_dict, self.main_view)
        ...
        self.icao7_data.update_icao_data(icao7, icao7_metar_data[0], icao7_metar_data[1], icao7_taf_data[0],
                                         icao7_taf_data[1], self.icao7_data.station_dict)
        self.update_fields.update_icao7(self.icao7_data.station_dict, self.main_view)
        ...
        self.icao8_data.update_icao_data(icao8, icao8_metar_data[0], icao8_metar_data[1], icao8_taf_data[0],
                                         icao8_taf_data[1], self.icao8_data.station_dict)
        self.update_fields.update_icao8(self.icao8_data.station_dict, self.main_view)
        ...
        self.icao9_data.update_icao_data(icao9, icao9_metar_data[0], icao9_metar_data[1], icao9_taf_data[0],
                                         icao9_taf_data[1], self.icao9_data.station_dict)
        self.update_fields.update_icao9(self.icao9_data.station_dict, self.main_view)
    ...
    def caps(self, event):
        ...
        self.main_view.app_view.icao0.set(self.main_view.app_view.icao0.get().upper())
    ...
    def view_metar_taf_icao0_data(self, event):
        ...
        msgbox.view_metar_taf_msg(self.icao0_data.station_dict['METAR'], self.icao0_data.station_dict['TAF'],
                                  self.icao0_data.station_dict['ICAO'])

    def view_metar_taf_icao1_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao1_data.station_dict['METAR'], self.icao1_data.station_dict['TAF'],
                                  self.icao1_data.station_dict['ICAO'])

    def view_metar_taf_icao2_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao2_data.station_dict['METAR'], self.icao2_data.station_dict['TAF'],
                                  self.icao2_data.station_dict['ICAO'])

    def view_metar_taf_icao3_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao3_data.station_dict['METAR'], self.icao3_data.station_dict['TAF'],
                                  self.icao3_data.station_dict['ICAO'])

    def view_metar_taf_icao4_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao4_data.station_dict['METAR'], self.icao4_data.station_dict['TAF'],
                                  self.icao4_data.station_dict['ICAO'])

    def view_metar_taf_icao5_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao5_data.station_dict['METAR'], self.icao5_data.station_dict['TAF'],
                                  self.icao5_data.station_dict['ICAO'])

    def view_metar_taf_icao6_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao6_data.station_dict['METAR'], self.icao6_data.station_dict['TAF'],
                                  self.icao6_data.station_dict['ICAO'])

    def view_metar_taf_icao7_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao7_data.station_dict['METAR'], self.icao7_data.station_dict['TAF'],
                                  self.icao7_data.station_dict['ICAO'])

    def view_metar_taf_icao8_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao8_data.station_dict['METAR'], self.icao8_data.station_dict['TAF'],
                                  self.icao8_data.station_dict['ICAO'])

    def view_metar_taf_icao9_data(self, event):
        msgbox = MetarTafDialog(self.root)
        msgbox.view_metar_taf_msg(self.icao9_data.station_dict['METAR'], self.icao9_data.station_dict['TAF'],
